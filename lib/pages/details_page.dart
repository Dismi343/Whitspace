     ...
     body:Center(
      ...
      children: [
        ...
        ElevatedButton(
          ...
          onPressed: (){
             setState(() {
              if(firstname==null||lastname==null||selectedDegreeProgram==null||selectedSemester==null||selectedYear==null){
                print("enter all details");
              }
              else{ 
                printdata();
                Navigator.push(context,MaterialPageRoute(builder: (context)=>SubjectSelection()));
                }
             });
          },
           child: Text("Next",
